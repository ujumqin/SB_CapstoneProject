...
```
## Introduction
After collecting text data from Twitter, Reddit, and the Official Overwatch forums, The text was analyzed using three sentiment lexicons: bing, nrc, and afinn. The results are plotted below.
...
The first being the word "mercy." Mercy is a character in Overwatch who has recently went over some changes in her abilities. Mercy being classified as positive isn't necessarily accurate, sine it is the name of a character. 
...
From this we can do additional research on what the community is saying about these two terms.
...
## Word clouds
These word clouds below can show us which words are being used the most by each communitiy despite sentiment.
