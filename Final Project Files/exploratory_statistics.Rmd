...
Since it seems that there may be a negativity problem, it will become important and useful to build an algorithm that can detect negativity for use in game. Toxic behavior in game will eventually become a customer service issue and finding an automated way to manage in game will save time and money. 